...
public class UserLogin extends AppCompatActivity {
    ...
    private void userSign() {
        ...
        if (TextUtils.isEmpty(email)) {
            Toast.makeText(UserLogin.this, "Enter the correct Email", Toast.LENGTH_SHORT).show();
            return;
        } else if (TextUtils.isEmpty(password)) {
            Toast.makeText(UserLogin.this, "Enter the correct password", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (!task.isSuccessful()) {
                    ...
                    Toast.makeText(UserLogin.this, "Login not successfull", Toast.LENGTH_SHORT).show();
